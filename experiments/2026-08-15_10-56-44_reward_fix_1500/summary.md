# Run `2026-08-15_10-56-44_reward_fix_1500`
...
|---|---|---|
| Train/mean_reward | -5.334 (it 0) | 27.124 (it 1499) |
| Train/mean_episode_length | - | 1000.00 (it 1499) |
| Perf/total_fps | - | 37769 |
...
| Episode_Reward/dof_acc_l2 | -0.0104 |
| Episode_Reward/dof_pos_limits | -0.0002 |
| Episode_Reward/dof_torques_l2 | -0.1133 |
| Episode_Reward/feet_air_time | 0.2152 |
| Episode_Reward/feet_slide | -0.0166 |
| Episode_Reward/flat_orientation_l2 | -0.0160 |
| Episode_Reward/joint_deviation_arms | -0.0550 |
| Episode_Reward/joint_deviation_hip_roll | -0.0111 |
| Episode_Reward/joint_deviation_hip_yaw | -0.0132 |
| Episode_Reward/joint_deviation_waist | -0.0148 |
| Episode_Reward/lin_vel_z_l2 | -0.0101 |
| Episode_Reward/termination_penalty | 0.0000 |
| Episode_Reward/track_ang_vel_z_exp | 0.4302 |
| Episode_Reward/track_lin_vel_xy_exp | 0.9238 |
